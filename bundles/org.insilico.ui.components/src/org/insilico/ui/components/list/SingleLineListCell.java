package org.insilico.ui.components.list;
...
/**
 * <h1>Single-Line ListCell</h1> Base class for a list cell which displays a single line of text.
 * 
 * <h2></h2> A additional {@link GraphicStyle} property can be used to control the style of the
 * cell. The real style of the cell is controlled by the style sheet.
 * 
